...
class CompleteDataSetTest {
    ...
    @Test
    fun `should return success when everything is right`() = runTest {
    ...
    @Test
    fun `should return error when there is any unhandled error`() = runTest {
        // Given dataset instance has no missing fields
        whenever(
            dataSetInstanceRepository.checkIfHasMissingMandatoryFields(
                dataSetUid,
    ...
    @Test
    fun `should return missing mandatory fields information`() = runTest {
    ...
    @Test
    fun `should return missing mandatory fields combination information`() = runTest {
