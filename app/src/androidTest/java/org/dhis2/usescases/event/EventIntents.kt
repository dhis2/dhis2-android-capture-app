...
const val FLOW_A_PROGRAM_UID = ANTENATAL_CARE_PROGRAM_UID
const val FLOW_A_STAGE_UID = "dBwrot7S420"
const val FLOW_A_ORG_UNIT_UID = "DiszpKrYNg8"
const val FLOW_A_DEFAULT_COC_UID = "HllvX50cXC0"
...
/**
 * Live event count for the Flow 1 program. Derived at runtime because the synced
 * baseline varies between runs (observed 4–5); includes the test's own event.
 */
