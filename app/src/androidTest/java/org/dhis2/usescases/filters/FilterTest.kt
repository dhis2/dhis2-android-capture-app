...
class FilterTest : BaseTest() {
    ...
    fun checkWritingOrgUnitFilter() {
        ...
        homeRobot {
            openFilters()
            checkItemsInProgram(composeTestRule, 3, "AUTOMATIC TESTING - Child Programme", "47")
            checkItemsInProgram(composeTestRule, 41, "AUTOMATIC TESTING - Child Health", "13")
            checkItemsInProgram(composeTestRule, 43, "AUTOMATIC TESTING - Contraceptives Voucher Program", "6")
        }
        cleanLocalDatabase()
    }
