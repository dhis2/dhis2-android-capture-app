...
class LoginActivityTest {
    ...
    fun loginButtonShouldBeDisplayedWhenAllFieldsAreFilled(){
        ...
        onView(withId(R.id.user_name_edit)).perform(replaceText(TEST_USERNAME), pressImeActionButton())
        onView(withId(R.id.user_pass_edit)).perform(replaceText(TEST_USERNAME), pressImeActionButton())
