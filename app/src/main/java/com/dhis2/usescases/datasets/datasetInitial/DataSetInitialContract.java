...
import com.dhis2.usescases.eventsWithoutRegistration.eventInitial.EventInitialContract;
...
public class DataSetInitialContract {
    ...
    public interface Presenter extends AbstractActivityContracts.Presenter {
        void init(DataSetInitialContract.View view, String datasetId, String orgUnitId);
