...
import org.hisp.dhis.android.core.settings.MetadataSyncPeriod.EVERY_12_HOURS
import org.hisp.dhis.android.core.settings.MetadataSyncPeriod.EVERY_24_HOURS
import org.hisp.dhis.android.core.settings.MetadataSyncPeriod.MANUAL
...
fun MetadataSyncPeriod.toSeconds(): Int {
    return when (this) {
        ...
        EVERY_12_HOURS -> EVERY_12_HOUR
        EVERY_24_HOURS -> EVERY_24_HOUR
