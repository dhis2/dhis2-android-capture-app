...
fun TrackedEntityInstance.profilePicturePath(
    d2: D2,
    programUid: String?,
): String {
...
fun Fragment.app(): App = context?.applicationContext as App

fun Fragment.userComponent(): UserComponent? = app().userComponent()

fun AppCompatActivity.app(): App = applicationContext as App

fun AppCompatActivity.userComponent(): UserComponent? = app().userComponent()

fun Context.app(): App = applicationContext as App

fun Context.drawableFrom(
    @DrawableRes drawableResource: Int,
): Drawable? = AppCompatResources.getDrawable(this, drawableResource)
