...
public abstract class FileViewModel extends FieldViewModel {
    ...
    public static FieldViewModel create(String id, int layoutId, String label, Boolean mandatory, String value, String section, String description, ObjectStyle objectStyle, String url) {
