...
public class DateTimeRow implements Row<DateTimeHolder, DateTimeViewModel> {
    ...
    public DateTimeRow(LayoutInflater layoutInflater, FlowableProcessor<RowAction> processor, int viewType, boolean isBgTransparent, boolean accessDataWrite) {
    ...
    public DateTimeHolder onCreate(@NonNull ViewGroup parent) {
        ...
        switch (viewType) {
            case TIME:
                ...
                ((FormTimeTextBinding) binding).timeView.setCellLayout();
                break;
            case DATE:
                binding = DataBindingUtil.inflate(inflater,
                        R.layout.form_date_text, parent, false);
                ((FormDateTextBinding) binding).dateView.setCellLayout();
                break;
            default:
                binding = DataBindingUtil.inflate(inflater,
                        R.layout.form_date_time_text, parent, false);
                ((FormDateTimeTextBinding) binding).dateTimeView.setCellLayout();
                break;
        }
