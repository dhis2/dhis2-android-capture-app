...
class MapEventToFeatureCollection(private val mapGeometryToFeature: MapGeometryToFeature, private val bounds: BoundsGeometry) {
    ...
    fun map (eventList: List<Event>): Pair<FeatureCollection, BoundingBox> {
        ...
        return Pair<FeatureCollection, BoundingBox>(
                ...
                BoundingBox.fromLngLats(bounds.westBound, bounds.southBound, bounds.eastBound, bounds.northBound)
        )
    }
