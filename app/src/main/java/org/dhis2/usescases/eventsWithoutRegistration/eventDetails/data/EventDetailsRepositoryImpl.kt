...
class EventDetailsRepositoryImpl(
    ...
    override fun getProgramStage(): ProgramStage {
    ...
    override fun getObjectStyle(): ObjectStyle? {
    ...
    override fun getEditableStatus(): EventEditableStatus? {
        return eventUid?.let {
    ...
    override fun getMinDaysFromStartByProgramStage(): Int {
    ...
    override fun getStageLastDate(enrollmentUid: String?): Date {
        val activeEvents =
    ...
    override fun hasAccessDataWrite(): Boolean {
    ...
    override fun getFilteredOrgUnits(
        date: String?,
        parentUid: String?
    ...
    override fun getOrganisationUnit(orgUnitUid: String): OrganisationUnit? {
        return d2.organisationUnitModule().organisationUnits()
            .byUid()
            .eq(orgUnitUid)
            .one().blockingGet()
    ...
    override fun getOrganisationUnits(): List<OrganisationUnit> {
        return d2.organisationUnitModule().organisationUnits()
            .byOrganisationUnitScope(OrganisationUnit.Scope.SCOPE_DATA_CAPTURE)
            .byProgramUids(listOf(programUid))
            .blockingGet()
    ...
    override fun getGeometryModel(): FieldUiModel {
    ...
    override fun getCatOptionCombos(categoryComboUid: String): List<CategoryOptionCombo> {
    ...
    override fun getCategoryOptionCombo(
    ...
    override fun getCatOptionSize(uid: String?): Int {
    ...
    override fun getCategoryOptions(categoryUid: String): List<CategoryOption> {
    ...
    override fun getOptionsFromCatOptionCombo(): Map<String, CategoryOption>? {
    ...
    override fun catCombo(): CategoryCombo {
