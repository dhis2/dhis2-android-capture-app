...
class EventDetailResourcesProvider(
    ...
    fun provideEditionStatus(reason: EventNonEditableReason): String {
        return when (reason) {
            EventNonEditableReason.BLOCKED_BY_COMPLETION -> resourceManager.getString(R.string.blocked_by_completion)
            EventNonEditableReason.EXPIRED -> resourceManager.getString(R.string.edition_expired)
            EventNonEditableReason.NO_DATA_WRITE_ACCESS -> resourceManager.getString(R.string.edition_no_write_access)
            ...
            EventNonEditableReason.NO_CATEGORY_COMBO_ACCESS -> resourceManager.getString(R.string.edition_no_catcombo_access)
