...
class ProgramStageSelectionAdapter(
...
) : ListAdapter<ProgramStageData, ProgramStageSelectionViewHolder>(
        object :
            DiffUtil.ItemCallback<ProgramStageData>() {
            override fun areItemsTheSame(
                oldItem: ProgramStageData,
                newItem: ProgramStageData,
            ): Boolean = oldItem.programStage.uid() == newItem.programStage.uid()
    ...
    override fun onCreateViewHolder(
        ...
        val binding: ItemProgramStageBinding =
    ...
    override fun onBindViewHolder(
        holder: ProgramStageSelectionViewHolder,
        position: Int,
    ) {
