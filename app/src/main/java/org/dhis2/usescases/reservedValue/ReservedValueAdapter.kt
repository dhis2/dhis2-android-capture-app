...
class ReservedValueAdapter :
    ListAdapter<ReservedValueModel, ReservedValueAdapter.ReservedValueViewHolder>(
        object :
    ...
    override fun onCreateViewHolder(
        viewGroup: ViewGroup,
        viewType: Int,
    ): ReservedValueViewHolder {
        val binding =
            ItemReservedValueBinding.inflate(
    ...
    override fun onBindViewHolder(
        holder: ReservedValueViewHolder,
        position: Int,
    ) {
        holder.bind(getItem(position))
    }

    inner class ReservedValueViewHolder(
        private val binding: ItemReservedValueBinding,
