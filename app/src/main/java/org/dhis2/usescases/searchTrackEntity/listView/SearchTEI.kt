...
class SearchTEI : FragmentGlobalAbstract() {
    ...
    companion object {
        fun get(fromRelationships: Boolean): SearchTEI {
            return SearchTEI().apply {
...
//        (context as EventCaptureActivity).searchComponent.plus(
//                SearchTEListModule()
//        ).inject(this)
    }
