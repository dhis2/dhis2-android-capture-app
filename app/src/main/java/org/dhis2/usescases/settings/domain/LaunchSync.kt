...
class LaunchSync(
    ...
    sealed interface SyncAction {
        ...
        data class UpdateSyncDataPeriod(val seconds: Int) : SyncAction

        data class UpdateSyncMetadataPeriod(val seconds: Int) : SyncAction
    }
    ...
    data class SyncStatusProgress(
        ...
        fun hasSyncFinished(metadataWasRunning: Boolean, dataWasRunning: Boolean) =
            metadataSyncProgress == SyncStatus.Finished && metadataWasRunning ||
                dataSyncProgress == SyncStatus.Finished && dataWasRunning
    }
