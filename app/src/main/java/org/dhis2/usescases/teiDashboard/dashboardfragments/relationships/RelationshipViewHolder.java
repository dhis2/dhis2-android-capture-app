...
public class RelationshipViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bind(RelationshipContracts.RelationshipPresenter presenter, RelationshipViewModel
            relationships) {
    ...
    private void setAttributes
            (List<TrackedEntityAttributeValue> trackedEntityAttributeValueModels) {
