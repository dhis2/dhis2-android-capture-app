...
fun TroubleshootingScreen(
    ...
    Column(
        ...
        HorizontalDivider(modifier = Modifier.padding(start = 72.dp), thickness = if (languageSelectorVisible) 0.dp else 1.dp)
        LanguageSelector(
        ...
        HorizontalDivider(modifier = Modifier.padding(start = 72.dp), thickness = if (rulesValidationVisible) 0.dp else 1.dp)
