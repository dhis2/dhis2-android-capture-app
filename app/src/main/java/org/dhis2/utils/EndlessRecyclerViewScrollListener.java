...
public abstract class EndlessRecyclerViewScrollListener extends RecyclerView.OnScrollListener {
    ...
    public void onScrolled(RecyclerView view, int dx, int dy) {
        ...
        if (mLayoutManager instanceof StaggeredGridLayoutManager) {
            ...
            // blockingGet maximum element within the list
        ...
        // If the total item blockingCount is zero and the previous isn't, assume the
        ...
        // If it’s still loading, we check to see if the dataset blockingCount has
        // changed, if so we conclude it has finished loading and update the current page
        // number and total item blockingCount.
