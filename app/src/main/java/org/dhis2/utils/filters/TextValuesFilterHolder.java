...
class TextValuesFilterHolder extends FilterHolder {

    private final Pair<CategoryCombo, List<CategoryOptionCombo>> catComboData;

    TextValuesFilterHolder(@NonNull ItemFilterCatOptCombBinding binding, ObservableField<Filters> openedFilter, Pair<CategoryCombo, List<CategoryOptionCombo>> catCombData) {
