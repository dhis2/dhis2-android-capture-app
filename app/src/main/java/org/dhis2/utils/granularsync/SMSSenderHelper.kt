...
class SMSSenderHelper(
    ...
    private var smsQueue: Queue<String> =
    ...
    private fun generateActivityResultKey(): String = "sms" + mWho + "_rq#" + mNextLocalRequestCode.getAndIncrement()
}
