...
class FilterRepositoryTest {
    ...
    private fun mockFilterLabels() {
        ...
        whenever(filterResources.filterEventStatusLabel("programUid")) doReturn EVENT_STATUS
        ...
        whenever(filterResources.filterEventDateLabel("programUid")) doReturn EVENT_DATE
