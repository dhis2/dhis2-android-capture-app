...
class UpdateSmsModuleTest {
    ...
    @Test
    fun shouldReturnValidationErrorIfGatewayIsInvalid() = runTest {
        ...
        assertTrue((result as UpdateSmsModule.EnableSmsResult.ValidationError).validationResult == GatewayValidator.GatewayValidationResult.Invalid)
    }

    @Test
    fun shouldReturnValidationErrorIfGatewayIsEmpty() = runTest {
        val testingGateway = "+11111111111"
        ...
        assertTrue(result is UpdateSmsModule.EnableSmsResult.ValidationError)
        assertTrue((result as UpdateSmsModule.EnableSmsResult.ValidationError).validationResult == GatewayValidator.GatewayValidationResult.Empty)
    }

    @Test
    fun shouldEnableSmsModule() = runTest {
        val testingGateway = "+11111111111"
    ...
    @Test
    fun shouldDisableSmsModule() = runTest {
        val testingGateway = "+11111111111"
        val downloadingMessage = "downloading"
    ...
    @Test
    fun shouldReturnErrorIfEnableFails() = runTest {
        val testingGateway = "+11111111111"
        val downloadingMessage = "downloading"
        val disabledMessage = "sms disabled"
    ...
    @Test
    fun shouldReturnErrorIfDisableFails() = runTest {
        val testingGateway = "+11111111111"
        val enabledMessage = "sms enabled"
