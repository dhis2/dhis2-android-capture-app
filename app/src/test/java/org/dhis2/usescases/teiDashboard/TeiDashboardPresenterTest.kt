...
class TeiDashboardPresenterTest {
    ...
    fun `Should set data on init`() {
        ...
        val dashboardModel = DashboardProgramModel(
        ...
        whenever(
            repository.getTeiOrgUnits(programUid, teiUid)
        ...
        verify(view).setData(dashboardModel)
    }

    @Test
    fun `Should set data without program on init`() {
