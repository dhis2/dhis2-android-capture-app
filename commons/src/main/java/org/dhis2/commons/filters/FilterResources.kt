...
class FilterResources(
    ...
    fun defaultWorkingListLabel(): String = resourceManager.getString(R.string.working_list_default_label)
    ...
    fun lastNDays(days: Int): String = resourceManager.getString(R.string.filter_period_last_n_days).format(days)
    ...
    fun lastNYears(years: Int): String = resourceManager.getString(R.string.filter_period_last_n_years).format(years)

    fun lastNMonths(months: Int): String = resourceManager.getString(R.string.filter_period_last_n_months).format(months)

    fun lastNWeeks(weeks: Int): String = resourceManager.getString(R.string.filter_period__last_n_weeks).format(weeks)

    fun weeksThisYear(): String = resourceManager.getString(R.string.filter_period_weeks_this_year)

    fun monthsThisYear(): String = resourceManager.getString(R.string.filter_period_months_this_year)

    fun bimonthsThisYear(): String = resourceManager.getString(R.string.filter_period_bimonths_this_year)

    fun quartersThisYear(): String = resourceManager.getString(R.string.filter_period_quarters_this_year)

    fun thisYear(): String = resourceManager.getString(R.string.filter_period_this_year)

    fun monthsLastYear(): String = resourceManager.getString(R.string.filter_period_months_last_year)

    fun quartersLastYear(): String = resourceManager.getString(R.string.filter_period_quarters_last_year)
    ...
    fun lastNBimonths(bimonths: Int): String = resourceManager.getString(R.string.filter_period_last_n_bimonths).format(bimonths)

    fun lastNQuarters(quarters: Int): String = resourceManager.getString(R.string.filter_period_last_n_quarters).format(quarters)

    fun lastNSixMonths(months: Int): String = resourceManager.getString(R.string.last_n_months).format(months)

    fun thisFinancialYear(): String = resourceManager.getString(R.string.filter_period_this_financial_year)

    fun lastFinancialYear(): String = resourceManager.getString(R.string.filter_period_last_financial_year)

    fun lastNFinancialYears(financialYears: Int): String =
        resourceManager
            .getString(R.string.filter_period_last_n_financial_years)
            .format(financialYears)

    fun lastNBiWeeks(biweeks: Int) = resourceManager.getString(R.string.filter_period_last_n_biweeks).format(biweeks)
    ...
    fun filterEnrollmentDateLabel(programUid: String): String =
    ...
    fun filterAssignedToMeLabel(): String = resourceManager.getString(R.string.filters_title_assigned)
    ...
    fun dateFilterPeriodToText(dateFilterPeriod: DateFilterPeriod) =
        if (dateFilterPeriod.period() != null) {
            ...
            RelativePeriodToStringMapper(this)
                .span()
                .format(
