...
class DataSetFilterSearchHelper
    @Inject
    constructor(
        ...
        override fun applyFiltersTo(repository: DataSetInstanceSummaryCollectionRepository): DataSetInstanceSummaryCollectionRepository =
            repository
        ...
        override fun applySorting(repository: DataSetInstanceSummaryCollectionRepository): DataSetInstanceSummaryCollectionRepository =
            repository
    }
