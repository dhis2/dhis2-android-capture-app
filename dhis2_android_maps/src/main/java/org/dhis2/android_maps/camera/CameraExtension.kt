package org.dhis2.android_maps.camera
    ...
    if (bounds.latNorth == 0.0 && bounds.latSouth == 0.0 &&
        ...
        this.easeCamera(
            CameraUpdateFactory.newLatLngBounds(
                bounds,
                org.dhis2.android_maps.camera.DEFAULT_BOUND_PADDING
            ),
            org.dhis2.android_maps.camera.DEFAULT_EASE_CAMERA_ANIM_DURATION
        )
    }
}
