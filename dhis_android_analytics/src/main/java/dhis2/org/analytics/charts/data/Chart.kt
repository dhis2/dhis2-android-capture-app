...
import dhis2.org.analytics.charts.mappers.GraphToIndicator
...
class Chart private constructor(
    ...
    private val graphToIndicator: GraphToIndicator by lazy { GraphToIndicator() }
    ...
    fun getChartView(context: Context): View {
        return when (chartType) {
            ...
            ChartType.SINGLE_VALUE -> graphToIndicator.map(context, graphData)
