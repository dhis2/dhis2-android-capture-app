...
class GetEnrollmentAnalyticsUseCaseTest {
    ...
    @Test
    fun `Should return success result with graph list when repository succeeds`() =
        runTest {
            val expectedGraphs =
                listOf(
                    Graph(
    ...
    @Test
    fun `Should return failure result when repository throws exception`() =
        runTest {
    ...
    @Test
    fun `Should execute on io dispatcher`() =
        runTest {
