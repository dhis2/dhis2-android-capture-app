...
val FakeCustomIntents: List<CustomIntent> = listOf(
    CustomIntent.builder()
        ...
        .request(
            CustomIntentRequest.builder().arguments(
                listOf(
                    CustomIntentRequestArgument.builder().key("projectId")
                        .value("testDhisProjectId").build(),
                    CustomIntentRequestArgument.builder().key("moduleId").value("testDhisModuleId")
                        .build(),
                    CustomIntentRequestArgument.builder().key("userId").value("testDhisUserId")
                        .build(),
                ),
            ).build(),
        )
